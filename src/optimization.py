...
def get_loss():
    ...
    # CrossEntropyLoss is suitable for classification problems.
...
def get_optimizer(
    ...
    # Depending on the optimizer selected, create an instance of the optimizer.
    # Use the input parameters learning_rate, momentum and weight_decay.
